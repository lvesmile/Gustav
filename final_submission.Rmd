...
colnames(data42003)[1] <- "X.YY"
colnames(data42007)[1] <- "X.YY"
colnames(data42039)[1] <- "X.YY"
colnames(data42040)[1] <- "X.YY"
colnames(data42059)[1] <- "X.YY"
...
## Descirbe storm track from landfall to inland boundary
