...
time_series_buoy <- function(variable){
  
  colors <- c("42003" = "gray", "42007" = "tomato", "42039" = "pink", 
              "42040" = "skyblue", "42059" = "orange")
  ...
  ggplot()+
    ...
    labs(y = variable, x = "time", color = "Legend")+
    scale_color_manual(values = colors)
...
ggplot()+
  geom_line(data = data42003_clean, aes(x=date_time, y=as.numeric(WDIR), color = "42003"))+
  geom_line(data = j2, aes(x=date_time, y=as.numeric(WDIR), color = "42007")) +
  geom_line(data = data42039_clean, aes(x=date_time, y=as.numeric(WDIR), color = "42039")) +
  geom_line(data = j3, aes(x=date_time, y=as.numeric(WDIR), color = "42040")) +
  geom_line(data = data42059_clean, aes(x=date_time, y=as.numeric(WDIR), color = "42059")) +
